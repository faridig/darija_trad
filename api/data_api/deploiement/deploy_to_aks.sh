...
# Le chemin est relatif au dossier 'deploiement'
K8S_CONFIG_FILE="../../k8s/data-api.yaml"
ACR_NAME="iaapi"
IMAGE_NAME="darija-data-api"

# --- CONFIGURATION DES SECRETS (CHARGEMENT DEPUIS .env) ---
# Ce script s'attend à trouver un fichier .env à la racine du projet
ENV_FILE_PATH="../../.env"
...
# Vérification que les variables essentielles sont bien chargées depuis le .env
...
# Création du secret avec toutes les clés nécessaires pour toutes les applications
...
# Utilisation d'un délimiteur différent pour sed pour éviter les conflits avec les URLs
...
# Ajout : Attendre que le déploiement soit terminé
