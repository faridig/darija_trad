...
PHRASES = [
    "Pourriez-vous m'indiquer le chemin pour aller à la gare, Pourriez-vous m'indiquer le chemin pour aller à la gare" ,
    "Le rapport financier est correct ",
    "N'oubliez surtout de prendre vos clefs de prendre vos clefs ",
]
# ==============================================================================
